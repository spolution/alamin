...
<head>
    ...
    <title>Al - Amin :: <?php echo $title ?></title>
...
<body>
    ...
    <script src="<?php echo assets_url('bower_components/morrisjs/morris.min.js') ?>"></script>
    <script src="<?php echo assets_url('js/morris-data.js') ?>"></script>
