...
<div class="item">
	...
	<table class="input">
		<tr>
			<td>
				<label for="kode_kartu">kode kartu (harus diisi)</label><br />
				<?=form_input(array('name'=>'kode_kartu','id'=>'kode_kartu','value'=>$data['kode_kartu']));?>
				<br />&nbsp;
			</td>
			<td>
				<label for="saldo">saldo pulsa</label><br />
				<?=form_input(array('name'=>'saldo_pulsa','id'=>'saldo','value'=>$data['saldo_pulsa']));?>
		...
		<tr>
			<td>
				...
				<?=form_input(array('name'=>'nama_kartu','id'=>'nama_kartu','value'=>$data['nama_kartu']));?>
			</td>
			<td>
