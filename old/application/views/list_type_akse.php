...
<div class="item">
	...
	<div onClick="window.location.href='<?php echo site_url('type_aksesoris/add'); ?>'" class="tools" id="t-1" onmouseover="get_effect('t-1')" onmouseout="remove_effect('t-1')" title="Ke Form Tambah Jenis Aksesoris">
	...
	<?php
		...
		echo form_open('type_aksesoris',array('id'=>'form_search','style'=>'display:none;'));
				...
				echo "
					<tr class='".$class."'>
						...
						<td style='text-align: center;'>
							".anchor('type_aksesoris/edit/'.$row->id_type, '<img src="'.base_url('assets/img/edit.png').'" alt="edit" />', array('title'=>'Edit'))."  
							".anchor('type_aksesoris/delete/'.$row->id_type, '<img src="'.base_url('assets/img/failed.png').'" alt="delete" />', array('title'=>'Delete','onclick'=>"return confirm('Apakah anda yakin ingin menghapus data ini?');"))."
						</td>
					</tr>
				";
